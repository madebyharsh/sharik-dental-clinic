  ...
  return (
    <section className={styles.hero} id="hero">
      <div className={styles.container}>
        <div className={styles.badge}>🦷 Trusted Dental Care in Azamgarh</div>
        <h1 className={styles.heading}>
          Bright Smiles,<br /> Trusted Care
        </h1>
        <p className={styles.subtext}>
          Comprehensive dental treatments delivered with precision and compassion.
          Visit <strong>Dr. Mohd Sharik</strong> at Family Dental Care — where your
